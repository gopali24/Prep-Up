    ...
    render() {
        if (this.state.isMoreQuestion) {
            if (this.state.numPA < 0) {
                return (
                    <div>
                        <button className="btn btn-primary btn-lg" onClick={(e) => this.set4NextQuestion(e)}>Next Question</button>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <button className="btn btn-primary btn-lg" onClick={(e) => this.noMoreQuestion(e)}>Finish</button>
                        <br/>
